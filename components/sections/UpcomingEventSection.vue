    ...
    <UContainer>
      ...
      >
        ...
        <h3 class="text-2xl font-bold text-gray-700 mb-2">
          Tranquillo... stanno arrivando!
        </h3>
        <p class="text-gray-500 max-w-md mx-auto">
          Stiamo definendo gli ultimi dettagli del calendario. Torna a trovarci presto per scoprire i prossimi tornei.
        </p>
      </div>
...
onMounted(() => {
  ...
  if (cardsRef.value && content.value.events && content.value.events.length > 0) {
